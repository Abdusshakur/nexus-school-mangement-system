...
class TeacherAttendanceSettings(SQLModel, table=True):
    ...
    __tablename__ = "teacher_attendance_settings"  # pyright: ignore[reportIncompatibleVariableOverride]
...
class AttendanceQRSession(SQLModel, table=True):
    ...
    __tablename__ = "attendance_qr_sessions"  # pyright: ignore[reportIncompatibleVariableOverride]
...
class TeacherDailyAttendance(SQLModel, table=True):
    ...
    __tablename__ = "teacher_daily_attendance"  # pyright: ignore[reportIncompatibleVariableOverride]
    __table_args__ = (
...
class TeacherAttendanceEvent(SQLModel, table=True):
    ...
    __tablename__ = "teacher_attendance_events"  # pyright: ignore[reportIncompatibleVariableOverride]
