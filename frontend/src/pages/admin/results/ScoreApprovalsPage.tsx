...
export function ScoreApprovalsPage() {
  const {
    submissions,
    loadingSubmissions,
    loadSubmissions,
  ...
  return (
    <div className="space-y-6 pb-10">
      {/* Header */}
      <div>
        <h1 className="font-bold text-2xl text-slate-900">Manage approvals</h1>
        <p className="text-sm mt-0.5 text-slate-500">
          Review and approve subject scores submitted by teachers.
        </p>
      </div>
