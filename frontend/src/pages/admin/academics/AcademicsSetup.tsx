        ...
        <div className="flex-1 p-6 flex flex-col">
          <div className="mb-6">
            ...
            <p className="text-sm text-slate-500 mt-1">
              {activeTab === "classes" &&
                "Add class groups (e.g. Junior Secondary) and create classes under them."}
              {activeTab === "subjects" &&
                "Add subjects to class groups. Universal subjects can be applied to all groups at once."}
            </p>
          </div>
              ...
              <div className="flex-1 overflow-y-auto p-2">
                {loadingGroups ? (
                  ...
                  groups.map((group) => (
                    <div
                      key={group.id}
                      className={`p-3 rounded-lg flex items-center justify-between cursor-pointer mb-1 transition-colors group/item ${
                    ...
                    >
                      <span
                        className={`font-medium ${selectedGroup === group.id ? "text-indigo-700" : "text-slate-700"}`}
                      >
                        {group.name}
                      </span>
                      <button
              ...
              {selectedGroup ? (
                      ...
                      classesLoading ? (
                        ...
                        <>
                          ...
                          {displayedClasses.map((c) => (
                            <div
                              key={c.id}
                              className="p-3 rounded-lg flex items-center justify-between hover:bg-slate-50 mb-1 group/item border border-transparent hover:border-slate-100"
                            >
                ...
                <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
                  ...
                  <p className="text-sm text-slate-400 mt-1">
                    Click on a group to view and manage its{" "}
