...
export function MarkAttendance() {
  ...
  const handleSave = () => {
    ...
    setTimeout(() => {
      setSaved(false);
      navigate(ROUTES.ADMIN.ATTENDANCE);
    }, 1500);
  };
      ...
      <main className="flex-1 p-8 space-y-6 max-w-3xl w-full mx-auto">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-5 flex flex-wrap items-center gap-3 shadow-sm">
          ...
          <button
            ...
            className="px-4 py-2 rounded-xl text-xs font-bold bg-indigo-100 text-indigo-800 hover:bg-indigo-150 transition-colors cursor-pointer"
          >
            Present
          </button>
          <button
