    ...
    return (
      <div className="text-center py-12">
        ...
        <p className="text-slate-400 text-xs mt-1">
          Select an active coursework card on the left to review student
        ...
        <div className="space-y-2">
              ...
              <div className="flex justify-between items-center">
                ...
                {sub.status === "graded" ? (
                  <span className="text-indigo-600 font-bold text-xs flex items-center gap-0.5">
                    <CheckCircle size={12} /> {sub.grade}/
                    {activeAssignment.maxPoints}
                  </span>
                ) : (
          ...
          {activeSubmissions.length === 0 && (
            <p className="text-slate-400 text-xs py-4 text-center">
              No submissions yet for this newly added task.
            </p>
          )}
        </div>
      </div>
      ...
      {selectedSubmission && (
        <div className="pt-6 border-t border-slate-100 space-y-4">
          <div className="p-4 bg-slate-50 rounded-xl border border-slate-200">
            ...
            <p className="text-slate-700 text-sm leading-relaxed mt-1.5 italic">
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                ...
                <span className="text-slate-400 text-xs">
                  Max points: {activeAssignment.maxPoints}
                </span>
              </div>
              <input
                type="number"
