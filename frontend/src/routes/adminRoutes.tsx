...
import { AdminTeacherHistoryPage } from "../pages/admin/attendance/AdminTeacherHistoryPage";
...
import { SchoolRoles } from "../pages/admin/roles/SchoolRoles";
...
export const adminRoutes = (
  <Route path="/admin" element={<RoleRoute allowedRoles={[UserRole.ADMIN]} />}>
    ...
    <Route path="attendance/teacher-history" element={<AdminTeacherHistoryPage />} />
